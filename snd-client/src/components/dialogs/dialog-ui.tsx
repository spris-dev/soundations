...
export const DialogContainer: FunctionalComponent = ({ children }) => {
  return (
    <div className="w-screen h-screen md:w-3/5 md:max-w-3xl md:h-auto md:max-h-[60vh] flex flex-col bg-color-background rounded-md border-2 border-color-primary">
      {children}
    </div>
  )
}
...
export const DialogBody: FunctionalComponent = ({ children }) => {
  return (
    <div className="w-full p-4 grow flex items-center overflow-y-auto">
      {children}
    </div>
  )
}
...
export const DialogError: FunctionalComponent = ({ children }) => {
  return (
    <div className="w-auto h-20 ml-4 mr-4 p-4 shrink-0 items-center text-red-500 rounded-md border-2 border-red-500 overflow-auto">
      {children}
    </div>
  )
}
